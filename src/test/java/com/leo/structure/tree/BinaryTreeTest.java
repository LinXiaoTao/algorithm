...
public class BinaryTreeTest {
    ...
    public void testParentNode() {
        Assert.assertEquals(binaryTree.getParentNode(1), "M");
        Assert.assertEquals(binaryTree.getParentNode(2), "M");
        Assert.assertNull(binaryTree.getParentNode(0));
        Assert.assertEquals(binaryTree.getParentNode(9),"J");
        Assert.assertEquals(binaryTree.getParentNode(20),"H");
    }
